...
# Список людей с их днями рождения
people = [
    ...
    {'fio': 'Муратбеков Рустем Мусаканович', 'position': 'Глава офиса данных', 'department': 'Глава офиса данных', 'birthday': '2024-07-13'},
    {'fio': 'Джемалудинов Камиль Абдулович', 'position': 'Заместитель директора по МСБ', 'department': 'Администрация', 'birthday': '2024-07-13'},
    {'fio': 'Жанкина Динара Кабдылкалыковна', 'position': 'Начальник управления', 'department': 'Управление операционного дня', 'birthday': '2024-07-14'},
    {'fio': 'Медеуов Азат Игенбаевич', 'position': 'Зам.дир департамента-нач. управления', 'department': 'Управление учета депозитных операций', 'birthday': '2024-07-14'},
    ...
    {'fio': 'Секенова Дана Елдоскызы', 'position': 'Начальник управления', 'department': 'Управление качества клиентского сервиса', 'birthday': '2024-07-23'},
    {'fio': 'Князев Олег Александрович', 'position': 'Директор департамента', 'department': 'Департамент Homebank', 'birthday': '2024-07-23'},
    ...
    {'fio': 'Кусаинова Жамбы Токеновна ', 'position': 'Начальник управления', 'department': 'Управление развития систем отчетности', 'birthday': '2024-07-29'},
    {'fio': 'Миркамилов Мирзариф Мырхамудович', 'position': 'Начальник управления', 'department': 'Управ. ИТ аудита', 'birthday': '2024-07-29'},
...
def main():
    ...
    token = '6737928397:AAFyrr9oUTw4YjXZebQKGuYSU1rsb4URuMs'
    ...
    # Вставьте ваш токен сюда
    token = '7258862975:AAF_eM6o7v9UXlXkQ2k40xueruY33eNk0KQ'
    ...
    for person in people:
        ...
        if notify_day_before >= now:
            scheduler.add_job(
                ...
                args=[token, f"Завтра день рождения у {person['fio']} - {person['position']} ({person['department']}) {person['birthday']} "]
            )

        # Задача для отправки уведомления в день ДР в 9 утра по алматинскому времени
        notify_birthday = datetime.combine(birthday, time(13, 0, 0))
        ...
        if notify_birthday >= now:
            scheduler.add_job(
                ...
                args=[token, f"Сегодня день рождения у {person['fio']} - {person['position']} ({person['department']}) {person['birthday']} "]
            )
